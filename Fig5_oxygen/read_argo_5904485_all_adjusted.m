...
file=ls('5904485_20210510063349249.nc');
...
for n=1:1 %length(file)
    ...
    SCIENTIFIC_CALIB_EQUATION=ncread(in,'SCIENTIFIC_CALIB_EQUATION');
    SCIENTIFIC_CALIB_COEFFICIENT=ncread(in,'SCIENTIFIC_CALIB_COEFFICIENT');
    SCIENTIFIC_CALIB_COMMENT=ncread(in,'SCIENTIFIC_CALIB_COMMENT');
    return
    for m=1:length(juld)
...
% save('bio_argo_5904485_data_adjusted_all','T_id','T_lon','T_lat','T_pres','T_pres_qc',...
