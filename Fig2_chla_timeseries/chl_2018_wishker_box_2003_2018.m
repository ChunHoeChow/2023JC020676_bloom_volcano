...
%     'chl_std','chl_max') ;
load('chl_daily_mean_170_190_18_27_preciseA_bgc_2003_2018','chl_all','gt')
gt_all=gt; 
LL=[31,30,31,31];
p=0;
clear gt
...
L=length(time2);
for m=1:L
    I=find(gt_all(:,2)==gt(m,2) & gt_all(:,3)==gt(m,3));
    q=reshape(chl_all(:,:,I),1,[]);
    ave(m)=mean(q,'omitnan');
...
save('D:\on_going_proposal\running\science\on_going_paper\bloom_2018\whiskers_data_170_190_18_27_2003_2018','time2','Q2','Q3','Q1','wup','wdn','ave')
toc